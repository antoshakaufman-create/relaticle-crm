...
# Скрипт для удаленного запуска отладки на crmvirtu.ru
# IP сервера: 83.220.175.224

SERVER_IP="83.220.175.224"
USER="root"
SCRIPT_NAME="debug_remote.sh"

echo "=== Запуск удаленной диагностики на $SERVER_IP ==="
echo "Для продолжения может потребоваться ввести пароль от сервера."

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"

# 1. Копируем скрипт на сервер
echo "[1/3] Копирование скрипта диагностики на сервер..."
