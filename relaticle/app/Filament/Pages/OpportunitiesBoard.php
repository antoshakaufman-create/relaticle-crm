...
final class OpportunitiesBoard extends BoardPage
{
    ...
    {
        return __('resources.common.board');
    }

    public function getTitle(): string
    {
        return __('resources.opportunity.plural');
    }
    ...
    public function board(Board $board): Board
    {
        return $board
            ...
            ->columnActions([
                CreateAction::make()
                    ->label(__('resources.common.add_opportunity'))
            ...
            ->cardActions([
                Action::make('edit')
                    ->label(__('resources.common.edit'))
                    ->slideOver()
                ...
                Action::make('delete')
                    ->label(__('resources.common.delete'))
            ...
            ->filters([
                ...
                SelectFilter::make('contacts')
                    ->label(__('resources.opportunity.point_of_contact'))
