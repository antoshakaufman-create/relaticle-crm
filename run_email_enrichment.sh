...
sshpass -p "$PASS" scp -o StrictHostKeyChecking=no app/Services/LeadValidation/EmailValidationService.php $USER@$IP:$REMOTE_PATH/app/Services/LeadValidation/EmailValidationService.php
...
sshpass -p "$PASS" scp -o StrictHostKeyChecking=no app/Console/Commands/EnrichEmails.php $USER@$IP:$REMOTE_PATH/app/Console/Commands/EnrichEmails.php
