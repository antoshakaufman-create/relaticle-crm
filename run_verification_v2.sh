...
echo "=== Deploying Verification Tool (Strict) ==="
...
echo "=== Test 2 (Fake) ==="
sshpass -p "$PASS" ssh -o StrictHostKeyChecking=no $USER@$IP "cd $REMOTE_PATH && php8.5 artisan app:verify-email fake1234728@ral.ru"
